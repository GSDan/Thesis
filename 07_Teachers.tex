...
Over the course of the longitudinal study, several other, shorter engagements were held with other schools in the North East of England, during which teachers and other researchers created ParkLearn/OurPlace Activities for school students. This section will briefly cover these engagements. For the studies described in subsections \ref{sec:SenseExplorers} and \ref{sec:TyneFresh}, the use of OurPlace was a tertiary result: OurPlace was being used within these separate projects as an established tool, rather than being the subject of the research. 
