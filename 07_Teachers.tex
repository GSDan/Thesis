...
As these studies were running concurrently with the community engagements covered in Chapter \ref{chap:Community}, the application still existed as `ParkLearn' for the majority of them, without the features and re-branding of `OurPlace'.
