...
heritage stakeholders have very similar desires - commonality
desire to engage with younger audiences - tech seen as an entryway
As discussed in Chapter \ref{chap:DesignSpace}, 

wide variation in funding, technical knowledge/comfort

tension between the perceived need for tech integration, and the lack of funding

tension between the perceived need for tech integration, and the limitations of space
- lack of internet accessibility (e.g. caves, fields)
- space no longer reflects the memories of place (e.g. plaques) 

tension between the perceived need for tech, and the lack of visitor engagement with that tech - status symbol, competition with other sites?
