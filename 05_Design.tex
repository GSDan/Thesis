...
{\RaggedRight
\begin{tabularx}{0.95\textwidth}{ p{13mm} | p{30mm} X}
    {\small\textit{Icon}} 
    & {\small\textit{Name}}
...
\captionof{table}{The Task Types available within OurPlace, as described in the mobile application.}~\label{tab:TaskTypes}
