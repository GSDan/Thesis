...
\captionof{table}{The initial high-level, key functional requirements for a mobile learning technology designed for use by park rangers and visiting schools.}~\label{tab:InitialRequirements}
